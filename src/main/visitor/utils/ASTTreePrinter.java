...
public class ASTTreePrinter extends Visitor<Void> {
    ...
    @Override
    public Void visit(FptrInvokeStmt fptrInvokeStmt) {
        print(fptrInvokeStmt);
        fptrInvokeStmt.getFptrInvoke().accept(this);
        return null;
    }
    ...
    @Override
    public Void visit(FieldOrListAccess fieldOrListAccess) {
        print(fieldOrListAccess);
        fieldOrListAccess.getInstance().accept(this);
        fieldOrListAccess.getField().accept(this);
        return null;
    }

    @Override
    public Void visit(FptrInvoke fptrInvoke) {
        print(fptrInvoke);
        fptrInvoke.getInstance().accept(this);
